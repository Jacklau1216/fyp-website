...
# Load your dataset
data = load_data("xsum-half-human", "")

# Initialize GPT-2 model
gpt2 = myGLTR.GPT2().model

# Filename for saving the processed data
filename = "xsum-half-human-gltr.json"
...
for i in data:
    try:
        text = i["text"][:2048]  # Trim text if necessary
        ...
        pass
    # Save results incrementally, e.g., every 100 entries
